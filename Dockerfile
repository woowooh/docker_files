...
ADD apache-maven-3.6.3-bin.tar.gz /opt/soft/
RUN ls -lh /opt/soft/
...
RUN mv "/opt/soft/apache-maven-3.6.3" /opt/soft/maven
ADD settings.xml /opt/soft/maven/conf/

ENV JAVA_HOME=/opt/soft/jdk
ENV JRE_HOME=$JAVA_HOME/jre
ENV CLASSPATH=.:$JAVA_HOME/lib/dt.jar:$JAVA_HOME/lib/tools.jar:$JRE_HOME/lib:$CLASSPATH
ENV MAVEN_HOME=/opt/soft/maven
